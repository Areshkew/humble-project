...
@inject(UserController, BookController, RootController, ShopController, PaymentController, TicketController)
class ServerBootstrap:
    ...
    def __init__(self, app: FastAPI):
        ...
        self.app.include_router(self.paymentcontroller.route, prefix="/api")
        self.app.include_router(self.ticketcontroller.route, prefix="/api")
